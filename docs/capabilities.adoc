...
normalizes rendered text into a lowercase hyphenated slug. Rust callers can
register custom processors when constructing a `RuleSet`; CLI, Python, Java,
and C ABI callers use the builtin registry.
