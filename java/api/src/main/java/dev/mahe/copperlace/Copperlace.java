...
public final class Copperlace implements AutoCloseable {
	 ...
	 * @throws CopperlaceException      if the config cannot be parsed or compiled
	 */
	public static Copperlace fromStringWithProcessors(final String config,
	 ...
	 * @throws CopperlaceException  if the file cannot be loaded, parsed, or compiled
	 */
	public static Copperlace fromFileWithProcessors(final Path path, final Map<String, CopperlaceProcessor> processors) {
		Validate.notNull(path, "path must not be null");
		Objects.requireNonNull(processors, "processors");
	 ...
	 * @throws CopperlaceException      if the file cannot be loaded, parsed, or compiled
	 */
	public static Copperlace fromFileWithProcessors(final String path,
			final Map<String, CopperlaceProcessor> processors) {
		Validate.notBlank(path, "path must not be blank");
		Objects.requireNonNull(processors, "processors");
	 ...
	 * @return rendered text for {@code rule}
	 * @throws IllegalArgumentException if {@code config} or {@code rule} is blank, or {@code maxRecursionDepth} is
	 *                                  negative
	 * @throws CopperlaceException      if parsing, compilation, or rendering fails
	 */
	 ...
	 * @throws CopperlaceException      if parsing, compilation, or rendering fails
	 */
	public static String renderStringWithProcessors(final String config, final String rule,
			final Map<String, CopperlaceProcessor> processors) {
		Validate.notBlank(config, "config must not be blank");
		Validate.notBlank(rule, "rule must not be blank");
		Objects.requireNonNull(processors, "processors");
	 ...
	 * @param processors custom processor callbacks keyed by processor name
	 * @return rendered text for {@code rule}
	 * @throws NullPointerException     if {@code context}, {@code processors}, a key, value, processor name, or
	 *                                  processor is null
	 * @throws IllegalArgumentException if {@code config} or {@code rule} is blank
	 * @throws CopperlaceException      if parsing, compilation, or rendering fails
	 */
	public static String renderStringWithProcessors(final String config, final String rule,
			final Map<String, String> context, final Map<String, CopperlaceProcessor> processors) {
		Validate.notBlank(config, "config must not be blank");
		Validate.notBlank(rule, "rule must not be blank");
	 ...
	 * @throws CopperlaceException      if parsing, compilation, or rendering fails
	 */
	public static String renderString(final String config, final String rule, final Map<String, String> context) {
		Validate.notBlank(config, "config must not be blank");
		Validate.notBlank(rule, "rule must not be blank");
		Objects.requireNonNull(context, "context");
	...
	/**
	 * Renders one rule from a configuration string with limited recursion enabled, returning formatted JSON for
	 * object-valued rules.
	 *
	 * @param config            configuration text containing Copperlace rules
	 * @param rule              name of the rule to render
	...
	/**
	 * Renders one rule from a configuration string with initial context, returning formatted JSON for object-valued
	 * rules.
	 *
	 * @param config  configuration text containing Copperlace rules
	 * @param rule    name of the rule to render
	 ...
	 * @throws CopperlaceException      if parsing, compilation, or rendering fails
	 */
	public static String renderStringStructuredJson(final String config, final String rule, final boolean formatJson) {
		Validate.notBlank(config, "config must not be blank");
		Validate.notBlank(rule, "rule must not be blank");
	 ...
	 */
	public static String renderStringStructuredJson(final String config, final String rule,
			final Map<String, String> context, final boolean formatJson) {
		Validate.notBlank(config, "config must not be blank");
		Validate.notBlank(rule, "rule must not be blank");
		Objects.requireNonNull(context, "context");
	 ...
	 * @throws CopperlaceException      if loading, parsing, compilation, or rendering fails
	 */
	public static String renderFileWithProcessors(final Path path, final String rule,
			final Map<String, CopperlaceProcessor> processors) {
		Validate.notNull(path, "path must not be null");
		Validate.notBlank(rule, "rule must not be blank");
		Objects.requireNonNull(processors, "processors");
	 ...
	 * @param processors custom processor callbacks keyed by processor name
	 * @return rendered text for {@code rule}
	 * @throws NullPointerException     if {@code path}, {@code context}, {@code processors}, a key, value, processor
	 *                                  name, or processor is null
	 * @throws IllegalArgumentException if {@code rule} is blank
	 * @throws CopperlaceException      if loading, parsing, compilation, or rendering fails
	 */
	public static String renderFileWithProcessors(final Path path, final String rule, final Map<String, String> context,
			final Map<String, CopperlaceProcessor> processors) {
		Validate.notNull(path, "path must not be null");
		Validate.notBlank(rule, "rule must not be blank");
		Objects.requireNonNull(context, "context");
	 ...
	 * @throws CopperlaceException      if loading, parsing, compilation, or rendering fails
	 */
	public static String renderFileInferred(final Path path, final String rule, final Map<String, String> context) {
		Validate.notNull(path, "path must not be null");
		Validate.notBlank(rule, "rule must not be blank");
		Objects.requireNonNull(context, "context");
	 ...
	 * @throws CopperlaceException      if loading, parsing, compilation, or rendering fails
	 */
	public static String renderFileStructuredJson(final Path path, final String rule, final Map<String, String> context,
	 ...
	 * @throws CopperlaceException      if loading, parsing, compilation, or rendering fails
	 */
	public static String renderFileWithProcessors(final String path, final String rule,
			final Map<String, CopperlaceProcessor> processors) {
		Validate.notBlank(path, "path must not be blank");
		Validate.notBlank(rule, "rule must not be blank");
		Objects.requireNonNull(processors, "processors");
	 ...
	 * @throws CopperlaceException      if loading, parsing, compilation, or rendering fails
	 */
	public static String renderFileInferred(final String path, final String rule, final Map<String, String> context) {
		Validate.notBlank(path, "path must not be blank");
		Validate.notBlank(rule, "rule must not be blank");
		Objects.requireNonNull(context, "context");
	...
	/**
	 * Renders a named rule with initial context and limited recursion enabled, returning formatted JSON for
	 * object-valued rules.
	 *
	 * @param rule              name of the rule to render
	 * @param context           initial render context values
	 ...
	 * @throws CopperlaceException      if this renderer is closed or rendering fails
	 */
	public String renderStructuredJson(final String rule, final Map<String, String> context, final boolean formatJson) {
		Validate.notBlank(rule, "rule must not be blank");
		Objects.requireNonNull(context, "context");
	...
	/**
	 * Renders a named structured rule from the loaded config as JSON text with initial context values and limited
	 * recursion enabled.
	 *
	 * @param rule              name of the structured rule to render
	 * @param context           initial render context values
